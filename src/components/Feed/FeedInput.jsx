...
export const FeedInput = () => {
	...
	return (
		<div className='feed__posts-input'>
			<div className='feed__posts-input-main'>
				<div className='feed__posts-input-avatar-wrapper'>
					<img className='feed__posts-input-avatar' src={miniUserData.avatar} alt='avatar' />
				</div>
			...
			<button className='feed__posts-input-submit' onClick={handleClick}>
				Post
			</button>
		</div>
	);
